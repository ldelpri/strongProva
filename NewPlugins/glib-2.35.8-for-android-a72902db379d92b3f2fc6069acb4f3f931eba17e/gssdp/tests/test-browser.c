...
static void
resource_unavailable_cb (GSSDPResourceBrowser* resource_browser, const char* usn)
{
	/*g_print ("resource unavailable\n"
			 "  USN:      %s\n",
			 usn);*/

	LOGD("resource unavailable\nUSN:      %s\n", usn);
}
